...
const BRAND = {
  ...
  tagline: "Transformamos ideas en realidad digital. Desarrollo web y soluciones tecnológicas para tu negocio.",
};
...
const SERVICE_LINKS = [
  ...
  { label: "Sitios Web Corporativos", href: "#services" },
  { label: "Sistemas de Gestión", href: "#services" },
...
const FOOTER_TEXT = {
  ...
  madeWith: "Hecho con Next.js 14, TypeScript y Tailwind CSS",
};
// ════════════════════════════════════════════════════════════════════════════════
            ...
            <div className="flex gap-4">
              ...
              {SOCIAL_LINKS.twitter && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-primary-400 transition"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              © {currentYear} {BRAND.name}. {FOOTER_TEXT.copyright}
            </p>
